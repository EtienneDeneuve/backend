...
* /v1/types endpoint
*/
describe('Endpoint /v1/cmdb/types/2/items (GET all)', function() {
  it('Get the items of the type', function(done) {
    request
    .get('/v1/cmdb/types/2/items')
    ...
    .expect(function(response) {
      ...
      // TODO manage updated_at can be a date or null
